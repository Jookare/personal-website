...
const buttonTheme = {
    base: "flex bg-accent w-auto h-10 px-2 rounded-xl items-center text-zinc-400 transition-all duration-200",
    hover: "hover:scale-105 hover:text-white",
  };
...
export const Links = () => {
    ...
    return (
        <div id="links" className="h-12 pl-[180px] w-[800px] gap-4 flex mt-4 z-30">
